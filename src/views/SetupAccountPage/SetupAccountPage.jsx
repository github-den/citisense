...
export default function SetupAccountPage() {
  ...
  const [barangayQuery, setBarangayQuery] = useState(''); // Tracks typed text
  ...
  }, [session?.user?.id, usernameClean, usernameValid]);

  // Username Error Hierarchy
  ...
  // Barangay Error Hierarchy (Real-time trigger)
  const inlineBarangayError = useMemo(() => {
    ...
    return '';
  }, [isEmptyBarangay, showErrors, isBarangayTyping, hasAnyMatch, barangayQuery, barangay]);
          ...
          <PageSectionHeader
            ...
            title={(
              <div className={styles.inlineHeader}>
                ...
                <span className={styles.headerSub}>Make your digital identity — avatar and username</span>
              </div>
            )}
          />
        </div>
          ...
          <form className={styles.formContainer} onSubmit={onSubmit} noValidate>
            ...
            <div className={styles.actions}>
              ...
              <button 
                ...
                disabled={busy}
              >
                <span>{busy ? 'Completing setup...' : 'Complete setup'}</span>
              </button>
            </div>
          </form>
        </div>
